...
<asp:Content ID="Content5" ContentPlaceHolderID="container" runat="server">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                <asp:Button runat="server" ID="Book" CssClass="btn btn-custom" Text="Add Schedule" OnClick="Book_Click" />
            </div>
        </div>
        </div>
                ...
                <asp:Repeater ID="rptTable" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# int.Parse(Eval("shipping_status_id").ToString()) == 1 ? "<a href='SchedulePage.aspx?id="+ Eval("id")+"&&container-id="+ Eval("container_id")+"' class='btn btn-custom'>Change Shipping Status</a>":"Received Already"%>
